...
{
    public partial class View_activitylog : System.Web.UI.Page
    {
        ...
        {
            FileStream fileStream = new FileStream(Server.MapPath("~/Files/activity.pdf"), FileMode.Open, FileAccess.Read);
            return fileStream;
        }
    }
}